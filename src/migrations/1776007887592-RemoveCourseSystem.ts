...
export class RemoveCourseSystem1776007887592 implements MigrationInterface {
    name = 'RemoveCourseSystem1776007887592'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`payments\` DROP FOREIGN KEY \`FK_00097d3b3147848e3585aabb433\``);
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`courseId\` \`groupId\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`groups\` CHANGE \`stage\` \`stage\` enum ('primary', 'preparatory', 'secondary') NULL`);
        await queryRunner.query(`ALTER TABLE \`groups\` CHANGE \`grade\` \`grade\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`groups\` CHANGE \`track\` \`track\` enum ('scientific', 'literary', 'general') NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`groupId\` \`groupId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`exams\` DROP FOREIGN KEY \`FK_d194afbae15220e5d796a28bc59\``);
        await queryRunner.query(`ALTER TABLE \`payments\` DROP FOREIGN KEY \`FK_09739b0587054798a29e7eb17df\``);
        await queryRunner.query(`ALTER TABLE \`groups\` DROP FOREIGN KEY \`FK_e63173ac43b478c2fc0cc20ac39\``);
        await queryRunner.query(`ALTER TABLE \`users\` DROP FOREIGN KEY \`FK_7aff205df2c337240c14e6dd3a3\``);
        await queryRunner.query(`DROP INDEX \`IDX_b07ef753327f6dd3b3dae4332c\` ON \`users\``);
        ...
        await queryRunner.query(`ALTER TABLE \`exams\` ADD CONSTRAINT \`FK_d194afbae15220e5d796a28bc59\` FOREIGN KEY (\`groupId\`) REFERENCES \`groups\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`groupId\` \`groupId\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`groups\` CHANGE \`track\` \`track\` enum ('scientific', 'literary', 'general') NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`groups\` CHANGE \`grade\` \`grade\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`groups\` CHANGE \`stage\` \`stage\` enum ('primary', 'preparatory', 'secondary') NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_b07ef753327f6dd3b3dae4332c\` ON \`users\` (\`email\`, \`centerId\`)`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD CONSTRAINT \`FK_7aff205df2c337240c14e6dd3a3\` FOREIGN KEY (\`centerId\`) REFERENCES \`centers\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`payments\` CHANGE \`groupId\` \`courseId\` int NOT NULL`);
