...
export class Newalanany1775987184741 implements MigrationInterface {
    name = 'Newalanany1775987184741'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_7aff205df2c337240c14e6dd3a3\` ON \`users\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_b07ef753327f6dd3b3dae4332c\` ON \`users\` (\`email\`, \`centerId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_7aff205df2c337240c14e6dd3a3\` ON \`users\` (\`centerId\`)`);
    }
